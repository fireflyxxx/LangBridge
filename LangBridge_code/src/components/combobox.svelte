...
<div class="relative z-10" use:tooltip use:clickOutside={() => (hasFocus = false)}>
	...
	<input
		type="text"
		class="input font-sans py-2 pr-2 pl-10 w-48 text-black"
	...
	<div class="suggestions text-black" style="background-color:white" class:hidden={!hasFocus || !filteredOptions.length}>
...
<style lang="postcss">
    .suggestions {
        ...
        background-color: theme('colors.gray.400'); /* 修改了背景颜色 */
